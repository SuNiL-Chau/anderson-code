  ...
  btn.addEventListener("click", () => {
    tabButtons.forEach(allbtns => {
      if (allbtns == prevBtn) {
        ...
        let tab = document.querySelector("[data-tab=\"".concat(tabValue, "\"]"));
...
Accbuttons.forEach(btn => {
  btn.addEventListener("click", () => {
    ...
    accContent.style.maxHeight = btn.classList.contains("show") ? accContent.offsetWidth + "px" : "0";
  });
});
...
let allProgramCheckboxes = document.querySelectorAll(".accordion__checkbox.programCheck");
...
let allCampusCheckboxes = document.querySelectorAll(".accordion__checkbox.campus");
...
let allCommitmentCheckboxes = document.querySelectorAll(".accordion__checkbox.commitment");
...
let allwhystudyCheckboxes = document.querySelectorAll(".accordion__checkbox.whystudy");
...
let allStepsCheckboxes = document.querySelectorAll(".accordion__checkbox.Steps");
